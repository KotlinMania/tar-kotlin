...
kotlin {
    ...
    val xcf = XCFramework("Tar")

    macosArm64 {
        binaries.framework { baseName = "Tar"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Tar"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Tar"
        flattenPackage = "io.github.kotlinmania.tar"
    }

    android {
        namespace = "io.github.kotlinmania.tar"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tar-kotlin", version.toString())

    pom {
        name.set("tar-kotlin")
        description.set("Kotlin Multiplatform port of alexcrichton/tar-rs - A Rust implementation of a TAR file reader and writer. This library does not currently handle compression, but it is abstract over all I/O readers and writers. Additionally, great lengths are taken to ensure that the entire contents are never required to be entirely resident in memory all at once")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tar-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tar-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tar-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tar-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTarXCFramework",
    "assembleTarDebugXCFramework",
    "assembleTarReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTarXCFramework",
    "assembleReleaseIosFatFrameworkForTarXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTarXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTarXCFramework",
    "assembleDebugMacosFatFrameworkForTarXCFramework",
    "assembleReleaseMacosFatFrameworkForTarXCFramework",
    "assembleDebugTvosFatFrameworkForTarXCFramework",
    "assembleReleaseTvosFatFrameworkForTarXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTarXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTarXCFramework",
    "assembleDebugWatchosFatFrameworkForTarXCFramework",
    "assembleReleaseWatchosFatFrameworkForTarXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTarXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTarXCFramework",
