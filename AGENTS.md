...
This file is the quick-reference operating contract for tar-kotlin. The longer
...
tar-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tar`](https://crates.io/crates/tar). Upstream Rust is the behavioral oracle while the
